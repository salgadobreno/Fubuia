...
module EventCalendar
  ...
  module ClassMethods
    ...
    #TODO: allow for first_day_of_week behaviour?
    def event_strips_for_week(shift = 0, find_options = {})
      strip_start = Date.today - 3 + shift.to_i
      strip_end = Date.today + 4 + shift.to_i
